  ...
  return <div className="min-h-screen">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto mb-12 md:text-xl text-base text-center">Explore our students' research and creative output, generated by using latest AI tools. Demo video links are available on request.</p>
