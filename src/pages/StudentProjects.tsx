  ...
  return <div className="min-h-screen">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto text-xl">Explore our students' research and creative output, generated by using latest AI tools. 
