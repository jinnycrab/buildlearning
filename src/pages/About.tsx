          ...
          <div className="space-y-12">
            ...
            {!isMobile && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  <img 
                    src="https://images.unsplash.com/photo-1484863137850-59afcfe05386?auto=format&fit=crop&q=80" 
                    alt="Parents supervising students" 
                    className="absolute inset-0 w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/60 to-black/80"></div>
                  <div className="absolute inset-0 p-6 flex flex-col justify-end">
                ...
                <CarouselContent>
                  ...
                  <CarouselItem className="pl-4 basis-[85%] min-w-0">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 p-6 flex flex-col justify-end">
                        <h3 className="font-semibold mb-2 text-lg text-white">Disengaged and Stressed Students</h3>
                        <p className="text-white/90">As educators, we know that many students recognise the stakes on making to their desired University course. Yet, under the stress of preparing for these one-off major examinations, many have lost the joy and engagement of learning.</p>
                      </div>
                    </motion.div>
                  </CarouselItem>
                  ...
                  <CarouselItem className="pl-4 basis-[85%] min-w-0">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 p-6 flex flex-col justify-end">
                        <h3 className="font-semibold mb-2 text-lg text-white">Anxious and Conflicted Parents</h3>
                        <p className="text-white/90">In our conversations with parents, we observed that many feel conflicted about their children's education. They know what is at stakes for college admission, yet want their children to enjoy learning and their teenage years.</p>
                      </div>
                    </motion.div>
                  </CarouselItem>
                  ...
                  <CarouselItem className="pl-4 basis-[85%] min-w-0">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 p-6 flex flex-col justify-end">
                        <h3 className="font-semibold mb-2 text-lg text-white">Frustrated Employers and Industry</h3>
                        <p className="text-white/90">In boardrooms, we often hear how employers find students "book smart" and "unprepared" for the working world. In fact, the World Economic Forum classified reading, writing and mathematics as "out-of-focus" skills compared to AI, technological literacy and creative problem solving.</p>
                      </div>
                    </motion.div>
                  </CarouselItem>
                </CarouselContent>
