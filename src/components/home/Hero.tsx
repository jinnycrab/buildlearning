  ...
  return (
    <section className="text-center max-w-3xl mx-auto mb-16">
      <h1 className="text-5xl font-bold mb-6 font-general-sans leading-tight">
        Want to be an innovator for <AnimatedWords/>
      </h1>
      <p className="text-xl text-muted-foreground mb-8">
        At Build, our students solve real-world problems, build portfolios, and prepare for a future in AI and innovation. 
      </p>
