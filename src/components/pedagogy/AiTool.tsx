...
export const AiTool = ({
  ...
  return <a href={link} target="_blank" rel="noopener noreferrer" className="relative h-[500px] rounded-xl overflow-hidden group block bg-white hover:shadow-lg transition-shadow">
      ...
      <div className="absolute inset-0 p-6 flex flex-col my-0 py-[25px]">
